define(['exports', 'extend', 'aurelia-logging', 'jwt-decode', 'aurelia-pal', 'aurelia-path', 'aurelia-dependency-injection', 'aurelia-metadata', 'aurelia-router', 'aurelia-fetch-client', 'aurelia-api', './authFilter'], function (exports, _extend, _aureliaLogging, _jwtDecode, _aureliaPal, _aureliaPath, _aureliaDependencyInjection, _aureliaMetadata, _aureliaRouter, _aureliaFetchClient, _aureliaApi) {
  'use strict';
  ...
  var Storage = exports.Storage = (_dec = (0, _aureliaDependencyInjection.inject)(BaseConfig), _dec(_class2 = function () {
    ...
    Storage.prototype.get = function get(key) {
      if (_aureliaPal.PLATFORM.global[this.config.storage]) {
  ...
  var AuthenticateStep = exports.AuthenticateStep = (_dec14 = (0, _aureliaDependencyInjection.inject)(Authentication), _dec14(_class11 = function () {
