define(['exports', 'aurelia-logging', 'extend', 'jwt-decode', 'aurelia-pal', 'aurelia-fetch-client', 'aurelia-api', 'aurelia-dependency-injection', 'aurelia-router', 'aurelia-metadata', 'aurelia-path', './authFilterValueConverter'], function (exports, _aureliaLogging, _extend, _jwtDecode, _aureliaPal, _aureliaFetchClient, _aureliaApi, _aureliaDependencyInjection, _aureliaRouter, _aureliaMetadata, _aureliaPath) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Storage = exports.Popup = exports.OAuth2 = exports.OAuth1 = exports.FetchConfig = exports.BaseConfig = exports.AuthService = exports.AuthorizeStep = exports.Authentication = exports.AuthenticateStep = exports.Auth0Lock = undefined;
  ...
  var Auth0Lock = exports.Auth0Lock = (_dec = (0, _aureliaDependencyInjection.inject)(Storage, BaseConfig), _dec(_class = function () {
  ...
  var AuthenticateStep = exports.AuthenticateStep = (_dec2 = (0, _aureliaDependencyInjection.inject)(AuthService), _dec2(_class2 = function () {
  ...
  var AuthorizeStep = exports.AuthorizeStep = (_dec10 = (0, _aureliaDependencyInjection.inject)(AuthService), _dec10(_class5 = function () {
  ...
  var AuthService = exports.AuthService = (_dec11 = (0, _aureliaDependencyInjection.inject)(Authentication, BaseConfig), _dec12 = (0, _aureliaMetadata.deprecated)({ message: 'Use .getAccessToken() instead.' }), _dec11(_class6 = (_class7 = function () {
  ...
  var FetchConfig = exports.FetchConfig = (_dec13 = (0, _aureliaDependencyInjection.inject)(_aureliaFetchClient.HttpClient, _aureliaApi.Config, AuthService, BaseConfig), _dec13(_class10 = function () {
  ...
  var OAuth1 = exports.OAuth1 = (_dec14 = (0, _aureliaDependencyInjection.inject)(Storage, Popup, BaseConfig), _dec14(_class11 = function () {
  ...
  var OAuth2 = exports.OAuth2 = (_dec15 = (0, _aureliaDependencyInjection.inject)(Storage, Popup, BaseConfig), _dec15(_class12 = function () {
  ...
  var Popup = exports.Popup = function () {
    ...
    Popup.prototype.pollPopup = function pollPopup() {
      ...
      return new Promise(function (resolve, reject) {
        _this16.polling = _aureliaPal.PLATFORM.global.setInterval(function () {
          var errorData = void 0;

          try {
            if (_this16.popupWindow.location.host === _aureliaPal.PLATFORM.global.document.location.host && (_this16.popupWindow.location.search || _this16.popupWindow.location.hash)) {
              ...
              _aureliaPal.PLATFORM.global.clearInterval(_this16.polling);
            }
          } catch (error) {
            errorData = error;
          }
  ...
  var Storage = exports.Storage = (_dec16 = (0, _aureliaDependencyInjection.inject)(BaseConfig), _dec16(_class13 = function () {
