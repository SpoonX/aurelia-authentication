declare module 'aurelia-authentication/authUtils' {
	 let authUtils: {
...
declare module 'aurelia-authentication/baseConfig' {
...
declare module 'aurelia-authentication/storage' {
...
declare module 'aurelia-authentication/authentication' {
...
declare module 'aurelia-authentication/app.fetch-httpClient.config' {
...
declare module 'aurelia-authentication/authFilter' {
	export class AuthFilterValueConverter {
	    toView(routes: any, isAuthenticated: any): any;
	}

}
declare module 'aurelia-authentication/popup' {
	export class Popup {
	    constructor(config: any);
...
declare module 'aurelia-authentication/oAuth1' {
	export class OAuth1 {
...
declare module 'aurelia-authentication/oAuth2' {
	export class OAuth2 {
	    constructor(storage: any, popup: any, config: any);
	    open(options: any, userData: any): any;
	    exchangeForToken(oauthData: any, userData: any, current: any): any;
...
declare module 'aurelia-authentication/authService' {
...
declare module 'aurelia-authentication/authorizeStep' {
...
declare module 'aurelia-authentication/index' {
