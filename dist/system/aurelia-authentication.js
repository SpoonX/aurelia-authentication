...
System.register(['aurelia-logging', 'extend', 'jwt-decode', 'aurelia-pal', 'aurelia-fetch-client', 'aurelia-api', 'aurelia-dependency-injection', 'aurelia-router', 'aurelia-metadata', 'aurelia-path', './authFilterValueConverter'], function (_export, _context) {
  "use strict";

  var LogManager, extend, jwtDecode, PLATFORM, DOM, HttpClient, Config, Rest, inject, Redirect, deprecated, join, buildQueryString, parseQueryString, _createClass, _dec, _class, _dec2, _class2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class3, _desc, _value, _class4, _dec10, _class5, _dec11, _dec12, _class6, _desc2, _value2, _class7, _dec13, _class10, _dec14, _class11, _dec15, _class12, _dec16, _class13, _typeof, Auth0Lock, AuthenticateStep, Authentication, AuthorizeStep, AuthService, BaseConfig, FetchConfig, OAuth1, OAuth2, camelCase, Popup, buildPopupWindowOptions, parseUrl, Storage;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('Auth0Lock', Auth0Lock = (_dec = inject(Storage, BaseConfig), _dec(_class = function () {
      ...
      _export('AuthenticateStep', AuthenticateStep = (_dec2 = inject(AuthService), _dec2(_class2 = function () {
      ...
      _export('AuthorizeStep', AuthorizeStep = (_dec10 = inject(AuthService), _dec10(_class5 = function () {
      ...
      _export('AuthService', AuthService = (_dec11 = inject(Authentication, BaseConfig), _dec12 = deprecated({ message: 'Use .getAccessToken() instead.' }), _dec11(_class6 = (_class7 = function () {
      ...
      _export('FetchConfig', FetchConfig = (_dec13 = inject(HttpClient, Config, AuthService, BaseConfig), _dec13(_class10 = function () {
      ...
      _export('OAuth1', OAuth1 = (_dec14 = inject(Storage, Popup, BaseConfig), _dec14(_class11 = function () {
      ...
      _export('OAuth2', OAuth2 = (_dec15 = inject(Storage, Popup, BaseConfig), _dec15(_class12 = function () {
      ...
      _export('Storage', Storage = (_dec16 = inject(BaseConfig), _dec16(_class13 = function () {
